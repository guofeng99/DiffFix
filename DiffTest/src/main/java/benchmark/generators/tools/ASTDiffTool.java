...
import benchmark.generators.tools.runners.DiffAutoTuning;
import benchmark.generators.tools.runners.DiffAutoTuningMod;
import benchmark.generators.tools.runners.IASTMapper;
import benchmark.generators.tools.runners.IASTMapperMod;
...
import benchmark.generators.tools.runners.gt.GreedyGumTreeASTDiffProviderMod;
import benchmark.generators.tools.runners.gt.SimpleGumTreeASTDiffProvider;
import benchmark.generators.tools.runners.gt.SimpleGumTreeASTDiffProviderMod;
...
public enum ASTDiffTool {
    ...
    RMD_Mod ("RefactoringMiner +DiffFix", (projectASTDiff, input, info, configuration) -> (ASTDiffProvider) () -> input),

    RMD_MT ("RefactoringMiner +MoveOpt", (projectASTDiff, input, info, configuration) -> (ASTDiffProvider) () -> input),

    GTG ("GumTree Greedy 3.0", (projectASTDiff, input, info, configuration) -> new GreedyGumTreeASTDiffProvider(input)),

    GTG_Mod ("GumTree Greedy 3.0 +DiffFix", (projectASTDiff, input, info, configuration) -> new GreedyGumTreeASTDiffProviderMod(input)),

    GTG_MT ("GumTree Greedy 3.0 +MoveOpt", (projectASTDiff, input, info, configuration) -> new GreedyGumTreeASTDiffProviderMod(input)),

    GTS ("GumTree Simple 3.0", (projectASTDiff, input, info, configuration) -> new SimpleGumTreeASTDiffProvider(input)),

    GTS_Mod ("GumTree Simple 3.0 +DiffFix", (projectASTDiff, input, info, configuration) -> new SimpleGumTreeASTDiffProviderMod(input)),

    GTS_MT ("GumTree Simple 3.0 +MoveOpt", (projectASTDiff, input, info, configuration) -> new SimpleGumTreeASTDiffProviderMod(input)),

    DAT ("Diff Auto Tuning", (projectASTDiff, input, info, configuration) -> new DiffAutoTuning(input)),

    DAT_Mod ("Diff Auto Tuning +DiffFix", (projectASTDiff, input, info, configuration) -> new DiffAutoTuningMod(input)),

    DAT_MT ("Diff Auto Tuning +MoveOpt", (projectASTDiff, input, info, configuration) -> new DiffAutoTuningMod(input)),
    ...
    ,
    IAM_Mod ("IASTMapper +DiffFix", (projectASTDiff, input, info, configuration) -> new IASTMapperMod(projectASTDiff,input))
    ,
    IAM_MT ("IASTMapper +MoveOpt", (projectASTDiff, input, info, configuration) -> new IASTMapperMod(projectASTDiff,input))
    ,
