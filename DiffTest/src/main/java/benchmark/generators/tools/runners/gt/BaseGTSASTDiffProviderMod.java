...
public class BaseGTSASTDiffProviderMod extends BaseASTDiffProvider {

    protected final CompositeMatchers.CompositeMatcher matcher;

    private final static Logger logger = LoggerFactory.getLogger(BaseGTSASTDiffProviderMod.class);

    protected BaseGTSASTDiffProviderMod(CompositeMatchers.CompositeMatcher matcher, ASTDiff input) {
        super(input);
    ...
    private ASTDiff makeASTDiffFromMatcher() {
        ...
        logger.info("GumTree-simple execution: " + (GT_finished - GT_started) + " milliseconds");
    ...
    protected ASTDiff mappingStoreToASTDiffWithActions(Tree srcRoot, Tree dstRoot, MappingStore match) {
        ...
        logger.info("GumTree-simple Fixing execution: " + (DFX_finished - DFX_started) + " milliseconds");
