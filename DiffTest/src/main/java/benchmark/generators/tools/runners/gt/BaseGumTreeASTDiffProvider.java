...
public class BaseGumTreeASTDiffProvider extends BaseASTDiffProvider {
    ...
    private final static Logger logger = LoggerFactory.getLogger(BaseGumTreeASTDiffProvider.class);
    ...
    private ASTDiff makeASTDiffFromMatcher() {
        ...
        logger.info("GumTree execution: " + (GT_finished - GT_started) + " milliseconds");
